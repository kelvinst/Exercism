defmodule FileSniffer do
  ...
  def verify(file_binary, extension) do
    file_binary
    |> type_from_binary()
    |> verify_types(type_from_extension(extension))
  end

  defp verify_types(type, type), do: {:ok, type}
  defp verify_types(_, _), do: {:error, "Warning, file format and file extension do not match."}
end
